...
const Home = () => {
    ...
    return <div className="flex rounded-md sm:justify-center bg-sky-950 m-2 sm:gap-20">
    ...
    <span   className="flex py-10 sm:m-6 ">  <DiReact /> <DiHtml5/> <DiJavascript/> <DiGit/> <DiCss3/> </span>
